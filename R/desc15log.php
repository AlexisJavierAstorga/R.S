...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Luce más delgada con este vestido." />
...
var sharing_name = 'Huichol moderno';
    ...
    <li class="home">
      <a class="home" href="index_.php" title="Volver a Inicio">
        <i class="fa fa-home"></i>
                  ...
                  <li class="last">Huichol moderno</li>
            </ul>
</div>
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Huichol moderno" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C16.jpg" title="Huichol moderno" alt="Huichol moderno"/>
                  </a>
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                        <form action="comprar.php" method="post" class="box">
                            <h1 itemprop="name">Huichol moderno</h1>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Huichol moderno'");
 if ($row = mysqli_fetch_array($result)){
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Luce más delgada con este vestido.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
