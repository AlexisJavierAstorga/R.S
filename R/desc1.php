...
<!-- /Breadcrumb -->
  ...
  <!--Replaced theme 2 -->
    ...
    <meta itemprop="url" content="desc1.php">
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                  ...
                  <div class="all-price-info">
                          <span id="our_price_display" itemprop="price" content="19.2">$32.00</span><meta itemprop="priceCurrency" content="USD" />                        </p>
 ...
 ?><br><br>
    ...
    <?php
        echo "<a href='compraslog.php'> <p><button class='btn btn-default'><span>Atras</span></button></p></a>";
    ?>
          </div>
            <!-- add to cart form-->
              <!-- hidden datas -->
