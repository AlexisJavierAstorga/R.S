...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="La moda está en el blanco y negro." />
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Cebra-hui" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C19.jpg" title="Cebra-hui" alt="Cebra-hui"/>
                  </a>
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>La moda está en el blanco y negro.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
