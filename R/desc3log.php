...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Lo nuevo que Ricardo Seco tiene solo para ti." />
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Loose Floral" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C4.jpg" title="Loose Floral" alt="Loose Floral"/>
                  </a>
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                        <form action="comprar.php" method="post" class="box">
                            <h1 itemprop="name">Loose Floral</h1>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Loose floral'");
 if ($row = mysqli_fetch_array($result)){
