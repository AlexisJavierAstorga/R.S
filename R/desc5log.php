...
var baseUri = 'index.html/index_.php';
...
<!-- /Breadcrumb -->
 ...
 <label for="Cantidad">Cantidad:</label>
    <p><input type="text" id="txtNumero1" name="txtNumero1" onkeypress="return valida(event)" maxlength="2" autofocus required/><input type="text" id="txtNumero2" value="40.00" readonly="" /></p>
    <br/>
