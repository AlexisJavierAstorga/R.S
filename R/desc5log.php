...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Esta blusa te hará sentir más fashion." />
...
var currency = {"id":1,"name":"Dollar","iso_code":"USD","iso_code_num":"840","sign":"$","blank":"","conversion_rate":"1.000000","deleted":"","format":"1","decimals":"1","active":"1","prefix":"$ ","suffix":"","id_shop_list":null,"force_id":false};
var currencyBlank = 0;
...
var customizationFields = [{"id_customization_field":"1","type":"","required":"1","name":"","id_lang":"1"},{"id_customization_field":"2","type":"1","required":"1","name":"","id_lang":"1"}];
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Lady Flor" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C6.jpg" title="Lady Flor" alt="Lady Flor"/>
                  </a>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Lady flor'");
 if ($row = mysqli_fetch_array($result)){
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Esta blusa te hará sentir más fashion.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
