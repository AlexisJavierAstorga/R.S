...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Para una ocasión." />
...
var sharing_name = 'Urban Shirty M02';
    ...
    <li class="home">
      <a class="home" href="index_.php" title="Volver a Inicio">
        <i class="fa fa-home"></i>
                  ...
                  <li class="last">Urban Shirty M02</li>
            </ul>
</div>
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Urban Shirty M02" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C12.jpg" title="Urban Shirty M02" alt="Urban Shirty M02"/>
                  </a>
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                        <form action="comprar.php" method="post" class="box">
                            <h1 itemprop="name">Urban Shirty M02</h1>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Urban shirty m02'");
 if ($row = mysqli_fetch_array($result)){
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Para una ocasión.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
