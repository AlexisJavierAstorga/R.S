...
<html lang="en-us"><head>
    <meta charset="utf-8" />
    <title>¿Qué hacemos y Quiénes somos? - R.S. Textil</title>
    ...
    <li class="home">
      <a class="home" href="index.php" title="Return to Home">
        <i class="fa fa-home"></i>
                  ...
                  <li class="last">¿Quiénes somos? y ¿Qué hacemos?</li>
            </ul>
</div>
...
<!-- /Breadcrumb -->
      ...
      <div class="rte">
<div class="border_bottom" style="text-align:center;">
  <h1 style="text-align:center;">¿Qué hacemos?</h1>
  <p><h4 ALIGN="justify">
    Somos una empresa que se dedica a la creacion de productos textiles para su posterior venta y
    asi poder ofecerla.</h4>
  </p>
  <h1 style="text-align:center;">¿Quiénes somos?</h1>
  <h3>OBJETIVO</h3>
  <p><h4 ALIGN="justify">
    Somos una empresa dedicada a la venta de indumentaria autóctona (Huichol), respetando toda la tradición
    de dicha vestidura.</h4>
  </p>
  <h3>Nuestra Misión</h3>
    <p><h4 ALIGN="justify">
      Ser una empresa líder en venta de ropa accesible en México ofreciendo ropa y servicio de alta calidad
      utilizando el estilo Huichol como inspiración de nuestro país.</h4>
    </p>
  <h3>Nuestra Visión</h3>
    <p><h4 ALIGN="justify">
      Pretende adaptar los productos a las necesidades de los clientes ofreciendo el tipo de ropa innovadora y
      atractiva para vestirse demanera informal, formal, elegante y de ocasión; logrando incrementar las ventas
      día con día.</h4>
    </p>
