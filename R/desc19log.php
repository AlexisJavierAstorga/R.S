...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Elegante y sutil a cualquier lado que vayas con nuestra moda." />
...
var sharing_name = 'Fashion Style';
    ...
    <li class="home">
      <a class="home" href="index_.php" title="Volver a Inicio">
        <i class="fa fa-home"></i>
                  ...
                  <li class="last">Fashion Style</li>
            </ul>
</div>
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Fashion Style" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C20.jpg" title="Fashion Style" alt="Fashion Style"/>
                  </a>
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                        <form action="comprar.php" method="post" class="box">
                            <h1 itemprop="name">Fashion Style</h1>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Fashion style2'");
 if ($row = mysqli_fetch_array($result)){
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Elegante y sutil a cualquier lado que vayas con nuestra moda.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
