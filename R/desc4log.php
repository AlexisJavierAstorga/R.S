...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Luce elegante con esta blusa." />
...
var sharing_name = 'Blusa azul con cenefa';
    ...
    <li class="home">
      <a class="home" href="index_.php" title="Volver a Inicio">
        <i class="fa fa-home"></i>
                  ...
                  <li class="last">Blusa azul con cenefa</li>
            </ul>
</div>
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Blusa azul con cenefa" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C5.jpg" title="Blusa azul con cenefa" alt="Blusa azul con cenefa"/>
                  </a>
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                        <form action="comprar.php" method="post" class="box">
                            <h1 itemprop="name">Blusa azul con cenefa</h1>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Blusa azul con cenefa'");
 if ($row = mysqli_fetch_array($result)){
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Luce elegante con esta blusa.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
