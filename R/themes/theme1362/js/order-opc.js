      ...
      if (!!$.prototype.fancybox) {
        $.fancybox({
          ...
          'afterLoad': function() {
            ...
            $('.fancybox-outer').append($('<div class="multishipping_close_container"><a id="multishipping-close" class="btn btn-default button btn-sm" href="#"><span>'+CloseTxt+'</span></a></div>'));
