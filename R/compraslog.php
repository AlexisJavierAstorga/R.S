...
<table border = "1">
<tbody>
  <tr><td>ID Venta</td><td>Correo</td><td>ID Producto</td><td>Nombre producto</td><td>Talla</td><td>Cantidad del producto</td><td>Total venta</td><td>Fecha de compra</td></tr>
<!-- /Breadcrumb -->
<?php
include("conexion.php");

$result = mysqli_query($con, "SELECT tbl_inventarioVentas.IDVEN,tbl_clientes.correo,tbl_inventarioProductos.IDPROD,tbl_inventarioProductos.nombre,tbl_inventarioVentas.talla,cantidadProducto,totalVenta,fechaCompra FROM tbl_inventarioVentas,tbl_inventarioProductos,tbl_clientes WHERE tbl_inventarioVentas.Cliente=tbl_clientes.IDCLI AND tbl_inventarioProductos.IDPROD=tbl_inventarioVentas.Producto AND tbl_inventarioVentas.Cliente='".$_SESSION['id']."'");
...
echo "¡ No haz realizado compras !";
 ...
 <tr>
   ...
   <td><a href='desc.php?IDVEN=<?php echo $row['IDVEN']; ?>'>Ver</a></td></tr>
