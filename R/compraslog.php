...
<link rel="stylesheet" href="themes/theme1362/css/tabla.css" media="all" />
...
$result = mysqli_query($con, "SELECT tbl_inventarioVentas.IDVEN,tbl_clientes.correo,tbl_inventarioProductos.IDPROD,tbl_inventarioProductos.nombre,cantidadProducto,totalVenta,fechaCompra FROM tbl_inventarioVentas,tbl_inventarioProductos,tbl_clientes WHERE tbl_inventarioVentas.Cliente=tbl_clientes.IDCLI AND tbl_inventarioProductos.IDPROD=tbl_inventarioVentas.Producto AND tbl_inventarioVentas.Cliente='".$_SESSION['id']."'");
...
if ($row = mysqli_fetch_array($result)){
  ...
  do {
      echo "<tr><td>".$row["IDVEN"]."</td><td>".$row["correo"]."</td><td>".$row["IDPROD"]."</td><td>".$row["nombre"]."</td><td>".$row["cantidadProducto"]."</td><td>".$row["totalVenta"]."</td><td>".$row["fechaCompra"]."</td></tr> \n";
...
/*
$result = mysqli_query($con, "SELECT * FROM tbl_clientes,tbl_inventarioProductos,tbl_inventarioVentas WHERE tbl_clientes.IDCLI=tbl_inventarioVentas.Cliente='".$_SESSION["u_usuario"]."'");
