...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Estampado Líneas." />
...
var sharing_name = 'Estampado Líneas';
    ...
    <li class="home">
      <a class="home" href="index_.php" title="Volver a Inicio">
        <i class="fa fa-home"></i>
                  ...
                  <li class="last">Estampado Líneas</li>
            </ul>
</div>
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Estampado Líneas" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C17.jpg" title="Estampado Líneas" alt="Estampado Líneas"/>
                  </a>
        ...
        <div class="pb-right-column col-sm-6 col-md-6 col-lg-4">
          <div class="product-info-line">
                        <form action="comprar.php" method="post" class="box">
                            <h1 itemprop="name">Estampado Líneas</h1>
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Estampado Líneas.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
