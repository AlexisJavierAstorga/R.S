...
<html lang="es-es"><head>
    ...
    <title>R.S. Textil</title>
          ...
          <meta name="description" content="Luce una de las colecciones limitadas del diseñador." />
...
<!-- /Breadcrumb -->
        ...
        <div class="pb-left-column col-sm-6 col-md-6 col-lg-8">
          ...
          <div id="image-block" class="clearfix is_caroucel">
                ...
                <span class="sale-label">&iexcl;Oferta!</span>
                                  ...
                                  <a class="jqzoom" title="Hui Black" rel="c1" href="#">
                    <img itemprop="image" src="themes/theme1362/img/index/cata/C13.jpg" title="Hui Black" alt="Hui Black"/>
                  </a>
 ...
 <?php
 include("conexion.php");
 $result = mysqli_query($con, "SELECT IDPROD FROM tbl_inventarioProductos WHERE nombre='Hui black'");
 if ($row = mysqli_fetch_array($result)){
    ...
    <br/><br/>
        ...
        <!-- end center infos-->
          ...
          <div class="tab-content col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="rte"><p>Luce una de las colecciones limitadas del diseñador.</p></div>
             </div>
                        <!-- quantity discount -->
                                      <!-- Data sheet -->
